...
class RB_E(nn.Module):    #Residual Block for Encoder (RB_E)
    def __init__(self,channel):                                
        ...
        self.conv_h = nn.Conv2d(channel,channel,kernel_size=3,stride=1,padding=3,dilation=3,bias=False)  
        self.conv_l = nn.Conv2d(channel,channel,kernel_size=3,stride=1,padding=3,dilation=3,bias=False) 
